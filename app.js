import cargarDatos from './src/js/datos.js';
import item from './src/js/item-curso.js';
import ListaItemCursos from './src/js/lista-item-cursos.js';
import PanelCiclo from './src/js/panel-ciclo.js';
import actualizarPanelResultados from './src/js/actualizar-resultados.js';
